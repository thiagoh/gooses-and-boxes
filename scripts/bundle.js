...
(function(game) {
	...
	var _shoot = function(event) {
		...
		game.raycaster = new THREE.Raycaster(game.camera.position, vector.sub(game.camera.position).normalize());
		...
		if (intersects.length > 0) {
			...
			_fireObject(intersects[0].object);
		...
		console.log('fireSeq: ' + game.fireSeq);
	};
...
(function(module) {
	...
	var _game = (function() {
		...
		_this.renderer = null;
		_this.camera = null;
		_this.breedCreationFunction = null;
		_this.creationInterval = null;
		_this.raycaster = null;
		_this.goose = null;
		_this.gun1 = null;
		_this.fireSeq = 0;
		_this.ammoCount = 30;
		_this.ammoIncreaseFunction = null;
		_this.ammoIncreaseInterval = null;
		_this.ammoIncreaseTimeInterval = 1000;
		_this.score = 0;
		_this.scorediff = 0;
		_this.timeInterval = 1300;
		_this.boxSizeFactor = 10;
		_this.minBoxSize = 2;
		_this.minGooseSize = 4;
		_this.gooseMaterial = null;
		_this.mesh = null;
		_this.direction = LEFT_TO_RIGHT;
		_this.box = null;
		_this.ground = null;
		_this.controls = null;
		_this.last = new Date().getTime();
		...
		_this.initGame = function() {
			...
			_this.gooseMaterial = new THREE.MeshLambertMaterial({
				map: THREE.ImageUtils.loadTexture('/images/goose.jpg')
			});

			_this.goose = (new THREE.JSONLoader()).parse(window.gooseJson).geometry;
